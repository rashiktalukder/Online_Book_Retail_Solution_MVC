    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM = new()
            {
                ...
                OrderDetail = _unitOfWork.OrderDetails.GetAll(x => x.OrderHeaderId == orderId, includeProperties: "Product")
            };
            return View(OrderVM);
        }
        ...
        public IActionResult ShipOrder()
        {
            ...
            if(orderHeaderFromDb.OrderStatus == SD.PaymentStatusApprovedForDelayedPayment)
            {
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            OrderVM.OrderDetail = _unitOfWork.OrderDetails.GetAll(o => o.OrderHeaderId == OrderVM.OrderHeader.Id, includeProperties: "Product");

            //indirect to stripe payment
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    objOrderHeaders = objOrderHeaders.Where(x=>x.OrderStatus == SD.StatusPending);
                    break;
                case "inprocess":
